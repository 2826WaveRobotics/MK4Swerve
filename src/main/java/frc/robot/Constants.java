...
public class Constants {
     ...
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.5588; // FIXME Measure and set wheelbase
    ...
    public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 43; // FIXME Set front left module steer motor ID
    ...
    public static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 18; // FIXME Set back left drive motor ID
    public static final int BACK_LEFT_MODULE_STEER_MOTOR = 52; // FIXME Set back left steer motor ID
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 7; // FIXME Set back left steer encoder ID
